...
docker tag $INPUT_GCRHOSTNAME/$INPUT_GKEPROJECTID/$REPONAME:$TAG $INPUT_GCRHOSTNAME/$INPUT_GKEPROJECTID/$REPONAME:$TAG || exit 1
docker push $INPUT_GCRHOSTNAME/$INPUT_GKEPROJECTID/$REPONAME:$TAG || exit 1
