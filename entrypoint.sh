...
echo "Deploy to GKE"
kubectl set image deployment/$INPUT_GKEDEPLOYMENTNAME $INPUT_GKEDEPLOYMENTNAME=$INPUT_GCRHOSTNAME/$INPUT_GKEPROJECTID/$REPONAME:latest -n $INPUT_GKENAMESPACE
